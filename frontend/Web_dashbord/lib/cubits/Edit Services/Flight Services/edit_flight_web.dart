...
import 'package:web_dashbord/assest/data%20and%20model/edit_flight_model.dart';
import 'package:http/http.dart' as http;
import 'package:web_dashbord/screens/log_in.dart';
import 'package:web_dashbord/url_api.dart';

class EditFlightWeb {
  Future<void> fetchEditFlight(
    ...
    try {
      ...
      String body = jsonEncode(EditFlightModel(
        departureAirport,
        arrivalAirport,
        companyName,
        departureDate,
      ...
      final response =
          await http.post(Uri.parse('$baseUrl/updateFlight/$FlightId'),
              headers: {

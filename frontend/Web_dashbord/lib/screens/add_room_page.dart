...
import 'package:web_dashbord/screens/add_room_type_page.dart';
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            String hotelId = hId1.getId().toString();
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => AddRoomTypePage()));
                            final usersDetailsCubit = AddRoomCubit.get(context);

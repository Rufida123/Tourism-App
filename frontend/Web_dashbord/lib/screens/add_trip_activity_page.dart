...
class AddTripActivityPage extends StatefulWidget {
  const AddTripActivityPage({super.key});
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        String tripId = id2.getId().toString();
                        final usersDetailsCubit =
                            AddTripActivityDetailsCubit.get(context);
                        usersDetailsCubit.cubitAddTripActivityDetails(
                            nameActiviteController1.text, tripId);
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        final usersDetailsCubit =
                            AddTripActivityDetailsCubit.get(context);
                        usersDetailsCubit.cubitAddTripActivityDetails(
                            nameActiviteController2.text, tripId);
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Avtivity Added Successfuly',
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        final usersDetailsCubit =
                            AddTripActivityDetailsCubit.get(context);
                        usersDetailsCubit.cubitAddTripActivityDetails(
                            nameActiviteController3.text, tripId);
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Avtivity Added Successfuly',
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        final usersDetailsCubit =
                            AddTripActivityDetailsCubit.get(context);
                        usersDetailsCubit.cubitAddTripActivityDetails(
                            nameActiviteController4.text, tripId);
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Avtivity Added Successfuly',

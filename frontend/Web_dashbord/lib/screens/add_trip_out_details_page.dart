...
import 'package:web_dashbord/screens/add_trip_images_page.dart';
import 'package:web_dashbord/screens/add_trip_in_details_page.dart';

class AddTripOutDetailsPage extends StatefulWidget {
  const AddTripOutDetailsPage({super.key});

  @override
  State<AddTripOutDetailsPage> createState() => _AddTripOutDetailsPageState();
}

class _AddTripOutDetailsPageState extends State<AddTripOutDetailsPage> {
  ...
  // TextEditingController nameActivite1Controller = TextEditingController();
  // TextEditingController nameActivite2Controller = TextEditingController();
  // TextEditingController nameActivite3Controller = TextEditingController();
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        AddTripInDetailsPage()));
                            final usersDetailsCubit =
                                AddTripOutDetailsCubit.get(context);
                            usersDetailsCubit.cubitAddTripOutDetails(
                                nameController.text,

...
class EditRoomFeaturesPage extends StatefulWidget {
  const EditRoomFeaturesPage({required this.hotelId});
  final String hotelId;
  @override
  State<EditRoomFeaturesPage> createState() => _EditRoomFeaturesState();
}

class _EditRoomFeaturesState extends State<EditRoomFeaturesPage> {
                    ...
                    ElevatedButton(
                      onPressed: () {
                        final usersDetailsCubit =
                            EditRoomFeaturesCubit.get(context);
                        usersDetailsCubit.cubitAddRoomFeatures(
                            roomFeaturesController1.text, widget.hotelId);

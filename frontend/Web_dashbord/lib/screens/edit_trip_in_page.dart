...
class EditTripInDetailsPage extends StatefulWidget {
  const EditTripInDetailsPage({required this.tripId});
  final String tripId;
  @override
  State<EditTripInDetailsPage> createState() => _EditTripInDetailsPageState();
}

class _EditTripInDetailsPageState extends State<EditTripInDetailsPage> {
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            //     MaterialPageRoute(
                            //         builder: (context) =>
                            //             EditTripActivityPage()));
                            final usersDetailsCubit =
                                EditTripInDetailsCubit.get(context);
                            usersDetailsCubit.cubitEditTripInDetails(
                                nameController.text,

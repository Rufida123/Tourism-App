...
class FilterFlightWeb {
  Future<List<FlightFilterModel>> filterFlight(
    ...
    if (response.statusCode == 200) {
      ...
      if (response.statusCode == 200) {
        ...
        final jsonData = json.decode(response.body);
        final List<FlightFilterModel> flightList =
            (jsonData['filtered_flights'] as List)
                .map((flightJson) => FlightFilterModel.fromJson(flightJson))
                .toList();
        return flightList;
      } else {

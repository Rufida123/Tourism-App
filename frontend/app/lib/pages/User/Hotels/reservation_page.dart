import 'package:app/components/hotel_editing_reservation_dialog.dart';
...
class ReservationHotelPage extends StatelessWidget {
  ReservationHotelPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<HotelReservationPageCubit, HotelReservationPageState>(
      builder: (context, state) {
        final reservations =
            HotelReservationPageCubit.get(context).reservations;
        if (state is HotelReservationPageSuccess) {
          ...
          return Scaffold(
              ...
              bottomNavigationBar: HotelBottomNavigationBarWidget());
        } else if (state is HotelReservationPageLoading) {
          return Scaffold(
              backgroundColor: Colors.white,
...
class ReservationListItem extends StatelessWidget {
  ...
  final HotelReservationPageModel reservation;
                                ...
                                TextButton(
                                  onPressed: () {
                                    final hotelCancelReservationCubit =
                                        HotelCancelReservationCubit.get(
                                            context);
                                    ...
                                    hotelReservationPageCubit
                                        .cubitHotelReservationPage(); // Dismiss the dialog
                                  },
                                  child: Text('Yes'),
                                ),
                              ],
